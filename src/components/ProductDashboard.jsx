...
//       console.log('Raw API Response (as plain text):', rawData);
  
//       // Parse the outer response
//       const parsedResponse = JSON.parse(rawData);
//       console.log('Parsed Response Object:', parsedResponse);
  
//       // Extract the 'contents' field which contains the product data
//       const productsObject = parsedResponse.contents;
//       const productsData = JSON.parse(productsObject);  // Parse 'contents' string
//       console.log('Parsed Products Data:', productsData);
  
//       // Convert the products object to an array
//       const productsArray = Object.values(productsData.products);  // Extract products
//       console.log('Products Array:', productsArray);
  
//       if (Array.isArray(productsArray)) {
//         setProducts(productsArray);  // Set the products array to state
//         setError(null);  // Clear any errors
//       } else {
//         console.log('Products data is not in the expected format:', productsArray);
